...
uses
  Classes, SysUtils, FileUtil, Forms, Controls, Graphics, Dialogs, StdCtrls,windows,inifiles;
...
if chkcred.Checked then
  begin
  if credwrite(widestring(txttarget.Text),WideString(txtusername.Text ),WideString(txtnewpwd.Text ))=false
